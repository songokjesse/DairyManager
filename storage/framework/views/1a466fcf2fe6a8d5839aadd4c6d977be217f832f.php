...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Animal <?php echo e($animal->id); ?></div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> <?php echo e($animal->name); ?> </td></tr><tr><th> Breed </th><td> <?php echo e($animal->breed); ?> </td></tr><tr><th> Calves </th><td> <?php echo e($animal->calves); ?> </td></tr>
                                </tbody>
                            </table>
                        </div>
